...
from .ddsimplekt import ddsimplekt
from .ddsaint import ddsaint
from .desakt import desakt
from .ddakt import ddakt
...
def init_model(model_name, model_config, data_config, emb_type):
    if model_name == "dkt":
    ...
    elif model_name == "ddsaint":
        model = ddsaint(data_config["num_q"], data_config["num_c"], **model_config, emb_type=emb_type, emb_path=data_config["emb_path"]).to(device)
        ...
        model = ddakt(data_config["num_c"], data_config["num_q"], **model_config, emb_type=emb_type, emb_path=data_config["emb_path"]).to(device)
    ...
    elif model_name == "ddsimplekt":
        model = ddsimplekt(data_config["num_c"], data_config["num_q"], **model_config, emb_type=emb_type, emb_path=data_config["emb_path"]).to(device)
